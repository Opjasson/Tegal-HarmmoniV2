...
const SettingKuliner: React.FC<props> = ({ navigation, route }) => {
    ...
    // UseState = penyimpanan data sementara
        ...
        const fetchData = async () => {
            const response = await fetch("http://192.168.220.220:5000/kuliner");
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.navbar}>
                <Text style={styles.textNav}>Kuliner</Text>
            </View>
            ...
            <Button
                aksi={() => navigation.navigate("TambahKuliner")}
                style={styles.button}>
                + Tambah
            </Button>
            <Text></Text>
            <Button
                aksi={() => navigation.navigate("MainApp")}
                style={styles.button}>
                Back Home
            </Button>
